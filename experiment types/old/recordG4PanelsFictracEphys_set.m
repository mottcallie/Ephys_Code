% recordG4PanelsFictracEphys_set.m
%
% Trial Type Function
...
function [rawData, inputParams, rawOutput] = recordG4PanelsFictracEphys_set(settings,pattN,funcN,mode,duration)
...
%% ACQUIRE
disp(['Starting G4 display: ' patlookup.name])
