...
%
% Trial Type Function for displaying patterns on G4 panels and recording data 
% from FicTrac channels and electrophysiological (ephys) channels. This function 
% delivers specified optomotor stimuli while recording the associated data.
%
% INPUTS:
