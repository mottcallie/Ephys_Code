% batteryG4PanelsFictrac.m
%
% Trial Type Function for displaying a selected pattern on G4 panels and 
% recording data from FicTrac channels. This function is specifically designed 
% for battery trials.
%
% INPUTS:
...
%
function [rawData, inputParams, rawOutput] = batteryG4PanelsFictrac(settings,duration,pattN,funcN,stim)
