...
function [rawData, inputParams, rawOutput] = recordG4PanelsFictracEphysOpto_court(settings,duration)

%% INITIALIZE DAQ
inputParams.exptCond = 'G4PanelsFictracEphysOpto'; % name of trial type
